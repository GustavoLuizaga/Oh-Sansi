...
<body>
    ...
    <div class="header">
        ...
        @foreach($modalidades as $modalidad => $inscripcionesList)
        <table>
            <tr>
            ...
            @foreach($inscripcionesList as $index => $inscripcion)
            @php
            $estudiante = $inscripcion->inscripcion->estudiantes->first()->user;
            $grado = $inscripcion->inscripcion->grado;
            @endphp
            <tr>
                <td>{{ $index + 1 }}</td>
            ...
            <tr>
                <td colspan="4"></td>
                <td>{{ $inscripcionesList->count() }}</td>
                <td>{{ $inscripcionesList->count() * ($modalidad == 'Individual' ? 35 : ($modalidad == 'Duo' ? 25 : 15)) }} Bs</td>
            </tr>
        </table>
        @endforeach
        @endforeach
