    ...
    <div class="menu">
        ...
        <div class="menu-seccion">
            ...
            <ul>
                ...
                <li><a href="{{ route('estudiantes.lista') }}" class="{{ request()->is('/estudiantes') ? 'active' : '' }}"><i class="fas fa-chalkboard-teacher"></i> <span>Estudiantes</span></a></li>
                @endif
                @if($iusIds->contains(config('ius.DELEGADOS')))
                <li><a href="{{ route('delegado') }}" class="{{ request()->is('/delegado') ? 'active' : '' }}"><i class="fas fa-chalkboard-teacher"></i> <span>Delegados</span></a></li>
                @endif
                @if($iusIds->contains(config('ius.USUARIOS')))
                <li><a href="{{ route('usuarios') }}" class="{{ request()->is('/usuarios') ? 'active' : '' }}"><i class="fas fa-chalkboard-teacher"></i> <span>Usuarios</span></a></li>
                @endif
